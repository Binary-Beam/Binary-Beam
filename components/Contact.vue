<template>
  <div id="Contact-Us" class="bg-neutral-900">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-x-10 lg:gap-x-16">
        ...
        >
          <form>
            ...
            <div class="mt-2">
              ...
              <p class="mt-5">
                <a
                  class="group inline-flex items-center gap-x-2 py-2 px-3 bg-blue-300 font-medium text-sm text-neutral-800 rounded-full focus:outline-none"
                  href="#"
                >
                  Submit
                  <svg
        ...
        <div class="space-y-14">
          ...
          <div class="flex gap-x-5">
            ...
            <div class="grow">
              ...
              <address class="mt-1 text-neutral-400 text-sm not-italic">
                We are a digital agency based in Colombo, Sri Lanka. We all work
                together totally online.
              </address>
            </div>
          </div>
          <!-- End Item -->
          ...
          <div class="flex gap-x-5">
            ...
            <div class="grow">
              <h4 class="text-white font-semibold">Reach out to us:</h4>
              <br/>
              <a
                class="mt-1 text-neutral-400 text-sm"
                href="#sandev.net@gmail.com"
                target="_blank"
              >
                sandev.net@gmail.com
              </a>
              <br />
              <p class="mt-1 text-neutral-400 text-sm">(+94) 76 231 3562</p>
              <br />
              <a
                class="mt-1 text-neutral-400 text-sm"
                href="#sadaka678@gmail.com"
                target="_blank"
              >
                sadaka678@gmail.com
              </a>
              <p class="mt-1 text-neutral-400 text-sm">(+94) 77 018 1835</p>
            </div>
          </div>
          <!-- End Item -->
        </div>
